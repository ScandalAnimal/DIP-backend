...
public class NeuralNetworkService {
    ...
    private final FeatureReductionService featureReductionService;

    final LoadData loadData;

    public NeuralNetworkService(FileFactory fileFactory, EvaluationService evaluationService, FeatureReductionService featureReductionService,
            LoadData loadData) {
        this.fileFactory = fileFactory;
        this.evaluationService = evaluationService;
        this.featureReductionService = featureReductionService;
    ...
    public String handleEvaluation(MultilayerPerceptron multilayerPerceptron, NeuralNetworkModel neuralNetworkModel, FileFactory.TrainTest data)
            throws Exception {
    ...
    public String handleSplitData(NeuralNetworkModel neuralNetworkModel, int num, String retString) throws Exception {
        if (num <= 100) {
            ...
            return handleSplitData(neuralNetworkModel, num == 1 ? num + 9 : num + 10,
